...
public class Return_Book extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 150, 255, -1));

        jTextField2.setFont(new java.awt.Font("Trebuchet MS", 0, 22)); // NOI18N
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 230, 255, -1));

        jTextField3.setFont(new java.awt.Font("Trebuchet MS", 0, 22)); // NOI18N
        getContentPane().add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 310, 255, -1));
        ...
        getContentPane().add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 380, 255, -1));
        ...
        jLabel5.setPreferredSize(new java.awt.Dimension(900, 580));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String BookID=jTextField1.getText();
         ...
         try{
             database.ConnectionProvider.st.executeQuery(
        "update issue_book set returned_Book='YES' where book_id=('"+BookID+"') and Stud_Id=('"+StudentID+"')");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        ResultSet rs=database.ConnectionProvider.st.executeQuery(
         "select * from issue_book where book_id=('"+BookId+"')and Stud_Id=('"+StudentId+"')");
        if(rs.next()){
